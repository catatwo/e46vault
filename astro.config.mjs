...
export default defineConfig({
	...
	integrations: [
		starlight({
			title: 'E46 Vault',
			description:
				'The encyclopedic reference for the BMW E46 330Ci and 330i (1999-2006)',
			social: [
				{
					icon: 'github',
					label: 'GitHub',
					href: 'https://github.com/catatwo/e46vault',
				},
			],
			editLink: {
			...
			customCss: ['./src/styles/custom.css', './src/styles/e46-theme.css'],
			sidebar: [
				{
					label: 'Overview',
					collapsed: false,
